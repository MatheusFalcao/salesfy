...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { desc: @produto.desc, estoque: @produto.estoque, nome: @produto.nome, preco: @produto.preco, user_id: @produto.user_id }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { desc: @produto.desc, estoque: @produto.estoque, nome: @produto.nome, preco: @produto.preco, user_id: @produto.user_id }
    assert_redirected_to produto_path(assigns(:produto))
  end
